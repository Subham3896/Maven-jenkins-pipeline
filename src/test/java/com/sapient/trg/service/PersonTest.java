...
private Person person=null;
	...
	void testAllArgConstructor() {
		...
		assertThrows(IllegalArgumentException.class, ()-> person.getFirtsName());
	}
	...
	void testGetFirstName() {
		assertEquals("Ravi",person.getFirtsName());
	}

	
	@Test
	void testSetFirstName() {
		person.setFirtsName("Steve");
		assertEquals("Steve",person.getFirtsName());
	}
